function tauxa_wwb = liantongyu_wwb(tauxa,yu_taux,yu_taux2)
% compute the western wind burst region
...
for i1 = 1:size(tauxa,3)
    ...
    if isempty(x_n) || isempty(y_n)
        ...
        tauxa_wwb(:,:,i1) = region_taux.*region_p;
    end
end
end