clc;clear
aimpath = ['F:\2023PMM_Work\Figures_for_Publish\Figure\FigS14_Var_Nino34_Exp\'];
if exist(aimpath,'dir')~=7
    mkdir(aimpath);
end

for one = 1:6 % 1:NETP;2:SETP;3:TIOlg;4:NTAlg;5:NTAandTIOandPMMandSEPandWWBbmay;6:NTAandTIOandPMMandSEPandWWBOctNov
    two = 1;% 1:Spread;2:Every lines
    three = 1;% 1:ERA5;2:GODAS
    four = 2;% 1:text;2:no text, ENSO strength standard
    first_name = {'PMM','SEP','TIOlg','NTAlg','NTAandTIOandPMMandSEPandWWBbmay','NTAandTIOandPMMandSEPandWWBOctNov'};
    first_name2 = {'CESM-TP+NETP','CESM-TP+SETP','CESM-TP+TIO','CESM-TP+TA','CESM-TP+G+WWB1','CESM-TP+G+WWB2'};
    first_name3 = {'a','b','c','d','e','f'};
    second_name = {'Spread','Lines'};
    third_name = {'ERA5','GODAS'};
    legend_name = {'OBS',first_name2{one}};
    pathfig = [aimpath,'FigS14',first_name3{one},'_Var_Nino34_',first_name{one},'_',second_name{two},'_',third_name{three}];
...
%     text_month = {'Jan/23','   ','FMA','   ','AMJ','   ','JJA','   ','ASO','   ','OND','   ','DJF/24','  '};
...
%         ;255,119,15 ...% 7 °®ÂíÊË³È, All
        ...
        ;234,92,129 ...% 10 bilibiliºì, WWB1
        ;129,56,188 ...% 11 ²¥¿ÍÉ«, WWB2
%         ;76,168,248 ...% 12 À¶É«,WWBs
%       ;227,173,82 ...% ±¸Ñ¡É« Î¢²©»Æ
        ]/255; %
    ...
    color_plot2 = [100,100,100 ... % 1 »ÒÉ«£¬OBS
        ...
        %   ;255,226,205 ...% 7 µ­°®ÂíÊË³È, All
            ...
            ;247,197,210 ...% 10 µ­bilibiliºì, WWB1
            ;199,164,228 ...% 11 µ­²¥¿Í×Ï WWB2
%         ;182,219,252 ...%  12 µ­À¶É«,WWBs
%         ;249,234,185 ...% ±¸Ñ¡É« µ­Î¢²©»Æ
    ...
    set(gca,'xtick',xtick,'xticklabel',xticklabel,'ytick',ytick,'yticklabel',yticklabel,'Layer','top','FontSize',FontSize,'FontName',FontName);
    % xtickangle(0)
    ...
    text(1,3.5,['(',first_name3{one},')'],'FontSize',FontSize,'FontName',FontName,'Interpreter','None')
