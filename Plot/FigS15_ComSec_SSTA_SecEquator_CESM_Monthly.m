...
for one = 1:6 % 1:NETP;2:SETP;3:TIOlg;4:NTAlg;5:NTAandTIOandPMMandSEPandWWBbmay;6:NTAandTIOandPMMandSEPandWWBOctNov
    ...
    seven = 1;% 1:no colorbar; 2:colorbar
    ...
    aimpath = ['F:\2023PMM_Work\Figures_for_Publish\Figure\FigS15_SecEquator_Monthly\Color',num2str(six),'\'];
    if exist(aimpath,'dir')~=7
        mkdir(aimpath);
    end
    
    pathfig = [aimpath,seventh_name{seven},'FigS15',first_name3{one},'_Exp_',first_name{one},'_SSTA_Sec',fourth_name{four},third_name{three},'_',fifth_name{five},'_Color',num2str(six)];
    ...
    ssta = cat(3,ssta_obs2023,ssta_ensemble);
    t_ssta = cat(3,ones(size(ssta_obs2023)),t_ssta_ensemble);
    ...
    t_iso20a = data2.t_iso20a_ensemble;
    iso20a = data2.iso20a_ensemble;
...
%     clabel(cs3b,h3b,'FontName',FontName,'fontsize',FontSize3);
    ...
    if one == 1
        colorbar('FontSize',FontSize,'FontName',FontName)
        pathfig2 = [aimpath,seventh_name{2},'FigS15',first_name3{one},'_Exp_',first_name{one},'_SSTA_Sec',fourth_name{four},third_name{three},'_',fifth_name{five},'_Color',num2str(six)];
