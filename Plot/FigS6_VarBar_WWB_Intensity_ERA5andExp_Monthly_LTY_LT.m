...
for two = 1:1 % define WWB,1:0.05 N/m2;2:ref STD;3:0.05 and ref STD
    for four = 1:1 % 1:Obs SSTA ref cli;2:Obs SSTA ref middel 30days
        ...
        path1 = ['/Users/Shared/Previously Relocated Items/Security/F/2023PMM_Work/Data_Ensamble/Exp_',first_name{6},'/Taux_Casely_Daily/'];% TPCtrl
        struct = dir([path1,'*.mat']);name1 = {struct(2:end).name}';
        path2 = ['/Users/Shared/Previously Relocated Items/Security/F/2023PMM_Work/Data_Ensamble/Exp_',first_name{one},'/Taux_Casely_Daily/'];%
