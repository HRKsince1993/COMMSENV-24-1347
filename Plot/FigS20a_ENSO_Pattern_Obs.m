...
load('F:\2023PMM_Work\Figures_for_Response\bin_data\Re_Nino34_SSTA_ERA5_std1979to2023yr.mat');
data2 = load('F:\2023PMM_Work\Figures_for_Response\bin_data\Re_Nino34_WindA10m_ERA5_std1979to2023yr.mat');

fig_name = 'OBS';
pathfig = [aimpath,'FigS20_1_ENSO_',first_name{one},'_',fig_name];
