...
for one = 1:2 % 1:NETP;2:SETP;3:NTA_S;4:NTA_North
    first_name = {'NETP','SETP','NTA_S','NTA_N'};
    first_name2 = {'b','c','g','h'};
    first_name3 = {'NETP_New','SEP','NTA','NTA_North'};

    load(['F:\2023PMM_Work\bin_data\Mask_Tropics_Turn.mat']);
    data2 = load(['F:\2023PMM_Work\bin_data\Mask_',first_name3{one},'.mat']);
    mask_region2 = data2.mask_region;
    ...
    title(['CESM-TP+',first_name{one}],'FontName',FontName,'FontSize',FontSize,'Interpreter','None');
