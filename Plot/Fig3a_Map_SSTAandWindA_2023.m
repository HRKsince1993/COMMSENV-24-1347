...
pathfig = [aimpath,fifth_name{five},'Fig3a_Map_SSTAandWindA_2023_Color',num2str(three)];
...
fig1 = mean(bin_fig1(:,:,3:11),3)';
fig3 = mean(bin_fig3(:,:,3:11),3)';
fig4 = mean(bin_fig4(:,:,3:11),3)';
%%
close all;
...
m_text(lon_start,lat_end+ly_text,['(a)'],'FontName',FontName,'FontSize',FontSize2*four);
title('Anomalous SST&U10','FontName',FontName,'FontSize',FontSize2);
%%
