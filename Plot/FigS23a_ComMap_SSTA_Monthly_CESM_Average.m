...
for one = 1:1
    ...
    bin_lon = lon(a);
    bin_lat = lat(b);
    bin_fig1 = ssta_ensamble(a,b);
    bin_fig3 = tauxa_ensamble(a,b)*k_scale;
    bin_fig4 = tauya_ensamble(a,b)*k_scale;

    bin_ssta_test = t_ssta_ensamble(a,b);
    bin_uvela_test = t_tauxa_ensamble(a,b);
    bin_vvela_test = t_tauya_ensamble(a,b);
