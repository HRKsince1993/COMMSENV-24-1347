...
load('G:\ENSO_Work\Data_ENSO\SST_Global_Monthly_ERA5_1979to2023.mat');
data2 = load('G:\ENSO_Work\Data_ENSO\Wind10m_Global_Monthly_ERA5_Averaged_1940to2023.mat');

fig_name = 'OBS';
pathfig = [aimpath,'FigS19_1_',first_name{one},'_Cli_',fig_name,'_',num2str(date(1,1)),'to',num2str(date(end,1))]

a = data2.date(:,1) >= date(1,1) & data2.date(:,1) <= date(end,1);
u10m = data2.u10m(:,:,a);
v10m = data2.v10m(:,:,a);
clear data2
...
m_text(lon_start,lat_end+5,['(1) ',fig_name],'FontName',FontName,'FontSize',FontSize);
%%
