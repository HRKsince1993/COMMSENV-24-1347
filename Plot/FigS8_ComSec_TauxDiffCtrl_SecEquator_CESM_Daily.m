...
for one = 1:5 % 1:PMM;2:SEP;3:TIO;4:NTA;5:NTAandTIOandPMMandSEPlg;6:NTAandTIOandPMMandSEPandWWBb;7:NTAandTIOandPMMandSEPandWWBbmay;8:NTAandTIOandPMMandSEPandWWBb
    ...
    ssta = data1.ssta_ensamble(a1,:);
    t_ssta = data1.t_ssta_ensamble(a1,:);

    uvela = data2.uvela_ensamble(a1,c1,:);
    t_uvela = data2.t_uvela_ensamble(a1,c1,:);

    tauxa = data3.tauxa_ensamble(a1,:);
    t_tauxa = data3.t_tauxa_ensamble(a1,:);
    tauya = data4.tauya_ensamble(a1,:);
    t_tauya = data4.t_tauya_ensamble(a1,:);
    %%
    bin_ssta = ssta;
