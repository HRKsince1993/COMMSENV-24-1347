...
for one = 1:1 % 1:PMM;2:SEP;3:TIO;4:NTA;5:NTAandTIOandPMMandSEPlg;6:NTAandTIOandPMMandSEPandWWBb
    ...
    switch six
        case 1
            shflxa = sixth_bin(six) * data1a.slflxa_ensemble;% positive means heat ocean
            t_shflxa = data1a.t_slflxa_ensemble;
        case 2
            shflxa = sixth_bin(six) * data1a.ssflxa_ensemble;% positive means heat ocean
            t_shflxa = data1a.t_ssflxa_ensemble;
        case 3
            shflxa = sixth_bin(six) * data1a.slwflxa_ensemble;% positive means heat ocean
            t_shflxa = data1a.t_slwflxa_ensemble;
        case 4
            shflxa = sixth_bin(six) * data1a.sswflxa_ensemble;% positive means heat ocean
            t_shflxa = data1a.t_sswflxa_ensemble;
        case 5
            shflxa = sixth_bin(six) * data1a.sflxa_ensemble;% positive means heat ocean
            t_shflxa = data1a.t_sflxa_ensemble;
    end
    slflxa = sixth_bin(1) * data1b.slflxa_ensemble;% positive means heat ocean
    t_slflxa = data1b.t_slflxa_ensemble;
