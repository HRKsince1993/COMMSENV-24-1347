...
for one = 4:4 % 1:TPCtrl;2:NTAandTIOandPMMandSEPlg;3:NTAandTIOandPMMandSEPandWWBb;4:Ctrl
    two = 1;% 1:Spread;2:Every lines
    three = 1;% 1:ERA5;2:GODAS
    first_name = {'TPCtrl','NTAandTIOandPMMandSEPlg','NTAandTIOandPMMandSEPandWWBb','Ctrl'};
    first_name2 = {'CESM-TP','CESM-TP+G','CESM-TP+G+WWBs','CESM'};
    first_name3 = {'a','b','c','b'};
    second_name = {'Spread','Lines'};
    third_name = {'ERA5','GODAS'};
    legend_name = {'OBS',first_name2{one}};
    pathfig = [aimpath,'FigS23',first_name3{one},'_Var_Nino34_',first_name{one},'_',second_name{two},'_',third_name{three}];
    ...
    text_month = {'Jan/23','Feb','FMA','MAM','AMJ','MJJ','JJA','JAS','ASO','SON','OND','NDJ','DJF/24','JF'};
...
%         ;247,197,210 ...% 10 µ­bilibiliºì,WWB
    ...
    text(1,3.4,['(',first_name3{one},')'],'FontSize',FontSize,'FontName',FontName,'Interpreter','None')
    ...
    %%
    set(gcf,'PaperUnits','inches','PaperPosition',[-0.5 0 10 4],'color',[1 1 1],'PaperOrientation','landscape');
