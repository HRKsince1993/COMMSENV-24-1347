...
for one = 1:5 % 1:PMM;2:SEP;3:TIO;4:NTA;5:NTAandTIOandPMMandSEPlg;6:NTAandTIOandPMMandSEPandWWBb
    ...
    lon = data1.lon;
    lat = data1.lat;
    precia = data3.precia_ensemble;
    uvela = data2.uvela_ensemble;
    vvela = data2.vvela_ensemble;
    slpa = data4.slpa_ensemble;

    precia2 = precia*24*3600*1000;% change to mm/day
    
    t_precia = data3.t_precia_ensemble;
    t_uvela = data2.t_uvela_ensemble;
    t_vvela = data2.t_vvela_ensemble;
    t_slpa = data4.t_slpa_ensemble;
