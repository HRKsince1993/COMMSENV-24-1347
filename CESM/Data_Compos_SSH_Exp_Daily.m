...
for one = 36:37;% 1;Ctrl;2:NTA;3:PMM;4:TIO;5:TroPac:6£ºTPCtrl;7:NTA15;8:NTA30;9:AtlNino;10:NoWNP;11:NoPMM;12:NTAandTIO;13:TroPacNTA;14:PMMandNTA;15:TPCtrlG;16:SEP;
    ...
    for i1 = 1:length(name1)
        ...
        bin_ssh = data1.ssh + bin_ssh;
    end
    ssh_ensamble = bin_ssh/length(name1);
    ...
    save(savepath,'lon','lat','date','ssh_ensamble','readme','time','readme2');
