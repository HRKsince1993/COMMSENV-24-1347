...
for one = 1:10 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    path1 = ['F:\2023PMM_Work\Data_Ensamble\Exp_',first_name{one},'\SSHA_Casely\'];
    ...
    clear bin_ssha t_ssha_ensamble p_ssha_ensamble hh1 pp1
    ...
    clear t_ssha_ensamble p_ssha_ensamble hh1 pp1 h1 p1
    ...
    %%
    readme2 = name1;
    save(savepath,'lon','lat','date','ssha_ensamble','t_ssha_ensamble','p_ssha_ensamble','readme2');
