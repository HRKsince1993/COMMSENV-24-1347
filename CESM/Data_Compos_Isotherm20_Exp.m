...
for one = 1:10 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    iso20_ensamble = mean(bin_sst,3);
    
    clear t_iso20_ensamble p_iso20_ensamble hh1 pp1 h1 p1
    ...
    t_iso20_ensamble = hh1;
    p_iso20_ensamble = pp1;
    %%
    % k = 1;
    ...
    %%
    readme2 = name1;
    save(savepath,'sec_lon','date','iso20_ensamble','t_iso20_ensamble','p_iso20_ensamble','readme','readme2');
    clear iso20_ensamble t_iso20_ensamble p_iso20_ensamble
end