...
for one = 3:7 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    path1 = ['F:\2023PMM_Work\Data_Ensemble\Exp_',first_name{one},'\Taux_Casely\'];
    path2 = ['F:\2023PMM_Work\Data_Ensemble\Exp_',second_name{two},'\Taux_Casely\'];
    ...
    % hold off
    %%
    tauxa_ensemble = ssta_ensemble;
    t_tauxa_ensemble = t_ssta_ensemble;
    p_tauxa_ensemble = p_ssta_ensemble;
    readme2 = name1;
    save(savepath,'lon','lat','date','tauxa_ensemble','t_tauxa_ensemble','p_tauxa_ensemble','readme','readme2','lon_box','lat_box');
