...
for one = 40:40;% 1;Ctrl;2:NTA;3:PMM;4:TIO;5:TroPac:6£ºTPCtrl;7:NTA15;8:NTA30;9:AtlNino;10:NoWNP;11:NoPMM;12:NTAandTIO;13:TroPacNTA;14:PMMandNTA;15:TPCtrlG;16:SEP;
    ...
    path1 = ['F:\2023PMM_Work\Data_Ensamble\Exp_',first_name{one},'\Taux_Casely\'];
    path2 = ['F:\2023PMM_Work\Data_Ensamble\Exp_',second_name{two},'\Taux_Casely\'];
    ...
    savepath = [aimpath,'Compose_',name1{1}(1:4),'Diff',second_name{two},name1{1}(5:end-7),'.mat']
    ...
    for i1 = 1:length(name1)
        ...
        bin_sst(:,:,:,i1) = data1.taux;
        bin_sst_tp(:,:,:,i1) = data2.taux;
    end
    %%
    ...
    % hold off
    %%
    tauxa_ensamble = ssta_ensamble;
    t_tauxa_ensamble = t_ssta_ensamble;
    p_tauxa_ensamble = p_ssta_ensamble;
    readme2 = name1;
    save(savepath,'lon','lat','date','tauxa_ensamble','t_tauxa_ensamble','p_tauxa_ensamble','readme2');
    clear ssta_ensamble t_ssta_ensamble p_ssta_ensamble tauxa_ensamble t_tauxa_ensamble p_tauxa_ensamble readme
end