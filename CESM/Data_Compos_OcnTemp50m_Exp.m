...
for one = 40:41;% 1;Ctrl;2:NTA;3:PMM;4:TIO;5:TroPac:6£ºTPCtrl;7:NTA15;8:NTA30;9:AtlNino;10:NoWNP;11:NoPMM;12:NTAandTIO;13:TroPacNTA;14:PMMandNTA;15:TPCtrlG;16:SEP;
    ...
    path1 = ['F:\2023PMM_Work\Data_Ensamble\Exp_',first_name{one},'\OcnTemp50m_Global_Casely\'];
    ...
    load([path1,name1{1}]);
    savepath = [aimpath,'Compose_',name1{1}(4:end-7),'.mat']
    
    clear bin_sst
    for i1 = 1:length(name1)
        data1 = load([path1,name1{i1}]);
        bin_sst(:,:,:,i1) = data1.temp;
    end
    temp_ensamble = mean(bin_sst,4);
    ...
    %%
    readme2 = name1;
    save(savepath,'lon','lat','date','temp_ensamble','t_temp_ensamble','p_temp_ensamble','readme2');
    clear temp_ensamble t_temp_ensamble p_temp_ensamble
end