...
for one = 1:10 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    path1 = ['F:\2023PMM_Work\Data_Ensemble\Exp_',first_name{one},'\OcnTemp50m_Global_Casely\'];
    ...
    for i1 = 1:size(bin_sst,3)
        ...
        t_temp_ensemble(:,:,i1) = hh1;
        p_temp_ensemble(:,:,i1) = pp1;
    end
    %%
    % k = 1;
    ...
    %%
    readme2 = name1;
    save(savepath,'lon','lat','date','temp_ensemble','t_temp_ensemble','p_temp_ensemble','readme2');
    clear temp_ensemble t_temp_ensemble p_temp_ensemble
end