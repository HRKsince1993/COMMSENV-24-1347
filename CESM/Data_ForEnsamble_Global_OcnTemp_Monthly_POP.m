...
lat = 0;
%%
for one = 3:3;% 1;Ctrl;2:NTA;3:PMM;4:TIO;5:TroPac:6£∫TPCtrl;7:NTA15;8:NTA30;9:AtlNino;10:NoWNP;11:NoPMM;12:NTAandTIO;13:TroPacNTA;14:PMMandNTA;15:TPCtrlG;16:SEP;
...
%         ncdisp([path2,name2{1}])
        aimpath2 = ['F:\2023PMM_Work\Data_Ensamble\Exp_',first_name{one},'\OcnTemp50m_Global_Casely\'];
        ...
        for i2 = 1:length(name2)
            ...
            bin_temp = ncread([path2,name2{i2}],'TEMP',[1,1,1,1],[inf,inf,6,1]);% Ctrl
            bin_temp(bin_temp == 0) = nan;
            bin_temp2 = squeeze(mean(bin_temp,3));
            bin_temp3 = griddata(tlon,tlat,bin_temp2,lon_grid,lat_grid,'linear')';
            
            time = [time;bin_time];
            temp(:,:,end+1) = bin_temp3;
