...
for one = 3:7 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    path1 = ['F:\2023PMM_Work\Data_Ensamble\Exp_',first_name{one},'\SSH_Casely_Daily\'];
    ...
    path2 = ['F:\2023PMM_Work\Data_Ensamble\Exp_',second_name{two},'\SSH_Casely_Daily\'];
    ...
    ssha_ensamble = mean(bin_ssha,4);
    %%
    clear t_ssha_ensamble p_ssha_ensamble hh1 pp1
    for i1 = 1:size(bin_ssha,3)
        ...
        t_ssha_ensamble(:,:,i1) = hh1;
        p_ssha_ensamble(:,:,i1) = pp1;
    end
    %%
    readme2 = name1;
    save(savepath,'lon','lat','date','ssha_ensamble','t_ssha_ensamble','p_ssha_ensamble','time','readme2');
    clear ssha_ensamble t_ssha_ensamble p_ssha_ensamble
end