...
%         ,'NTAandTIOandPMMandSEPandWWBbmay','CESM_TP','NTAandTIOandPMMandSEPandWWBOctNov','TPCtrlNoWWB2'};
    ...
    slp_ensamble = mean(bin_sst,4);
    
    clear t_slp_ensamble p_slp_ensamble hh1 pp1 h1 p1
    for i1 = 1:size(bin_sst,3)
        ...
        t_slp_ensamble(:,:,i1) = hh1;
        p_slp_ensamble(:,:,i1) = pp1;
    end
    %%
%     k = 1;
...
%     colorbar;
    %%
    readme2 = name1;
    save(savepath,'lon','lat','date','slp_ensamble','readme','t_slp_ensamble','p_slp_ensamble','readme2');
    clear slp_ensamble readme t_slp_ensamble p_slp_ensamble
end
