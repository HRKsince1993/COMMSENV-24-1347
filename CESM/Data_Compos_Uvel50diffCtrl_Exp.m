...
for one = 3:7 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    path1 = ['F:\2023PMM_Work\Data_Ensamble\Exp_',first_name{one},'\OcnUvel50m_Global_Casely\'];
    path2 = ['F:\2023PMM_Work\Data_Ensamble\Exp_',second_name{two},'\OcnUvel50m_Global_Casely\'];
    ...
    savepath = [aimpath,'Compose_Uvel50diff',second_name{two},name1{1}(11:end-7),'.mat']
    ...
    size(bin_ssta)
    %%
    clear t_uvela_ensamble p_uvela_ensamble hh1 pp1
    ...
    %%
    readme2 = name1;
    save(savepath,'lon','lat','date','uvela_ensamble','t_uvela_ensamble','p_uvela_ensamble','readme','time','readme2');
