...
for one = 1:10 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    path1 = ['F:\2023PMM_Work\Data_Ensamble\Exp_',first_name{one},'\D20_Casely\'];
    ...
    load([path1,name1{1}]);
    savepath = [aimpath,'Compose_SecIso20A',name1{1}(4:end-7),'.mat']
    %%
    clear bin_sst
    for i1 = 1:length(name1)
        data1 = load([path1,name1{i1}]);
        bin_sst(:,:,i1) = data1.iso_20a;
    end
    iso20a_ensamble = mean(bin_sst,3);
    
    clear t_iso20a_ensamble p_iso20a_ensamble hh1 pp1 h1 p1
    ...
    t_iso20a_ensamble = hh1;
    p_iso20a_ensamble = pp1;
    %%
    % k = 1;
    ...
    %%
    readme2 = name1;
    save(savepath,'sec_lon','date','iso20a_ensamble','t_iso20a_ensamble','p_iso20a_ensamble','readme','readme2');
    clear iso20a_ensamble t_iso20a_ensamble p_iso20a_ensamble
end