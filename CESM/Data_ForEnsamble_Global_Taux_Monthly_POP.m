...
for one = 39:40;% 1;Ctrl;2:NTA;3:PMM;4:TIO;5:TroPac:6£ºTPCtrl;7:NTA15;8:NTA30;9:AtlNino;10:NoWNP;11:NoPMM;12:NTAandTIO;13:TroPacNTA;14:PMMandNTA;15:TPCtrlG;16:SEP;
    ...
    for i1 = 1:length(name1)
        ...
        aimpath = ['F:\2023PMM_Work\Data_Ensamble\Exp_',first_name{one},'\Taux_Casely\'];
        ...
        for i2 = 1:length(name2)
            ...
            bin_temp = ncread([path2,name2{i2}],'TAUX')*0.1;% N/m2
        ...
        %%
        taux = sst;
        datapath = [aimpath,'Taux_Global_Monthly_',num2str(date(1,1)),'-',num2str(date(1,2),'%2.2i'),'_to_'...
            ,num2str(date(end,1)),'-',num2str(date(end,2),'%2.2i'),'_',name1{i1},'.mat'];
        save(datapath,'lon','lat','taux','date','time','readme');
        i1
    end
    one
end