...
for one = 3:7 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    path2 = ['F:\2023PMM_Work\Data_Ensamble\Exp_',second_name{two},'\OcnWvel3D_Global_Casely\'];
    ...
    wvela_ensamble = mean(bin_wvela,4);
    %%
...
%     colorbar;
    %%
    save(savepath,'lon','lat','depth','date','wvela_ensamble','t_wvela_ensamble','p_wvela_ensamble','lon_box','lat_box','readme');
    clear wvela_ensamble t_wvela_ensamble p_wvela_ensamble readme
end
