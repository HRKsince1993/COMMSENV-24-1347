...
%         ,'NTAandTIOandPMMandSEPandWWBbmay','CESM_TP','NTAandTIOandPMMandSEPandWWBOctNov','TPCtrlNoWWB2'};
    ...
    sswflxa_ensamble = mean(mean(bin_ssta(:,:,l_mon,:),4),3);
    ...
    clear t_sswflxa_ensamble p_sswflxa_ensamble hh1 pp1 h1 p1
        ...
        t_sswflxa_ensamble = hh1;
        p_sswflxa_ensamble = pp1;
    %%
%     k = 1;
...
%     colorbar;
    ...
    clear sswflxa_ensamble readme t_sswflxa_ensamble p_sswflxa_ensamble
end