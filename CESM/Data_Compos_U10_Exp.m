...
for one = 2:10 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    vel_ensamble = mean(bin_sst,4);
    
    clear t_vel_ensamble p_vel_ensamble hh1 pp1 h1 p1
    for i1 = 1:size(bin_sst,3)
        ...
        t_vel_ensamble(:,:,i1) = hh1;
        p_vel_ensamble(:,:,i1) = pp1;
    end
    %%
%     k = 1;
%     contourf(lon,lat,slp_ensamble(:,:,k)');
%     colorbar;
    %%
    readme2 = name1;
    save(savepath,'lon','lat','date','vel_ensamble','readme','t_vel_ensamble','p_vel_ensamble','readme2');
    clear vel_ensamble readme t_vel_ensamble p_vel_ensamble
end
