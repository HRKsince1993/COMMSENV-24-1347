...
for one = 1:10 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    mld_ensemble = mean(bin_sst,4);
    
    clear t_mld_ensemble p_mld_ensemble hh1 pp1 h1 p1
    for i1 = 1:size(bin_sst,3)
        ...
        t_mld_ensemble(:,:,i1) = hh1;
        p_mld_ensemble(:,:,i1) = pp1;
    end
    %%
%     k = 1;
%     contourf(lon,lat,mld_ensemble(:,:,k)');
%     colorbar;
    %%
    readme2 = name1;
    save(savepath,'lon','lat','date','mld_ensemble','readme','t_mld_ensemble','p_mld_ensemble','readme2');
    clear mld_ensemble readme t_mld_ensemble p_mld_ensemble
end
