...
for one = 3:7 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    path2 = ['F:\2023PMM_Work\Data_Ensamble\Exp_',second_name{two},'\OcnTemp3D_Global_Casely\'];
    ...
    tempa_ensamble = mean(bin_ssta,4);
    %%
    clear t_tempa_ensamble p_tempa_ensamble hh1 pp1 h1 p1
    for i1 = 1:size(bin_ssta,3)
        ...
        t_tempa_ensamble(:,:,i1) = hh1;
        p_tempa_ensamble(:,:,i1) = pp1;
    end
    %%
%     k = 1;
...
%     colorbar;
    %%
    save(savepath,'lon','lat','depth','date','tempa_ensamble','t_tempa_ensamble','p_tempa_ensamble','lon_box','lat_box','readme');
    clear tempa_ensamble readme t_tempa_ensamble p_tempa_ensamble
end