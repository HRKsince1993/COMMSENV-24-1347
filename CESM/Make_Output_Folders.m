...
for one = 41:41 % 1;Ctrl;2:NTA;3:PMM;4:TIO;5:TroPac:6£ºTPCtrl;7:NTA15;8:NTA30;9:AtlNino;10:NoWNP;11:NoPMM;12:NTAandTIO;13:TroPacNTA;14:PMMandNTA;15:TPCtrlG;16:SEP
    ...
    if one >= 3 && one <= 22
        path = ['H:\CESM\Output_Data\HRK_2023ENSO_Ensamble\Exp_',first_name{one},'\Exp_',first_name{one},'_1217_']
    elseif one >= 23 && one <= 39
        path = ['H:\CESM\Output_Data\HRK_2023ENSO_Ensamble\Exp_',first_name{one},'\Exp_',first_name{one},'_0110_']
    elseif one >= 40
        path = ['H:\CESM\Output_Data\HRK_2023ENSO_Ensamble\Exp_',first_name{one},'\Exp_',first_name{one},'_0318_']
    end
    for i1 = 0:10
