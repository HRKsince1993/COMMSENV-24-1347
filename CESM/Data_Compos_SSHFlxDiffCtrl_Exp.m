...
for one = 4:10 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    ssflxa_ensemble = mean(bin_ssta,4);
    
    clear t_ssflxa_ensemble p_ssflxa_ensemble hh1 pp1 h1 p1
    for i1 = 1:size(bin_ssta,3)
        ...
        t_ssflxa_ensemble(:,:,i1) = hh1;
        p_ssflxa_ensemble(:,:,i1) = pp1;
    end
    %%
%     k = 1;
%     contourf(lon,lat,ssflxa_ensemble(:,:,k)');
%     colorbar;
    %%
