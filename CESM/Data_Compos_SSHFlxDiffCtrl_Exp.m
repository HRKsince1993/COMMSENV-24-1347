...
%         ,'NTAandTIOandPMMandSEPandWWBbmay','CESM_TP','NTAandTIOandPMMandSEPandWWBOctNov','TPCtrlNoWWB2'};
    ...
    ssflxa_ensamble = mean(bin_ssta,4);
    
    clear t_ssflxa_ensamble p_ssflxa_ensamble hh1 pp1 h1 p1
    for i1 = 1:size(bin_ssta,3)
        ...
        t_ssflxa_ensamble(:,:,i1) = hh1;
        p_ssflxa_ensamble(:,:,i1) = pp1;
    end
    %%
%     k = 1;
%     contourf(lon,lat,ssflxa_ensamble(:,:,k)');
%     colorbar;
    %%
