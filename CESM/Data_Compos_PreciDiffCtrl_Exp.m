...
for one = 39:39;% 1;Ctrl;2:NTA;3:PMM;4:TIO;5:TroPac:6£ºTPCtrl;7:NTA15;8:NTA30;9:AtlNino;10:NoWNP;11:NoPMM;12:NTAandTIO;13:TroPacNTA;14:PMMandNTA;15:TPCtrlG;16:SEP;
    ...
    precia_ensamble = mean(bin_ssta,4);
    ...
    for i1 = 1:size(bin_ssta,3)
        ...
        t_precia_ensamble(:,:,i1) = hh1;
        p_precia_ensamble(:,:,i1) = pp1;
    end
    %%
%     k = 1;
