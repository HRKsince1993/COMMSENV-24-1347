...
for one = 2:8 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    path1 = ['F:\2023PMM_Work\Data_Ensamble\Exp_',first_name{one},'\OcnVvel3D_Global_Casely\'];
    ...
    load([path1,name1{1}]);
    savepath = [aimpath,'Compose_z',name1{1}(1:end-7),'.mat']
    %%
    clear bin_sst
...
%     colorbar;
    %%
    readme2 = name1;
    save(savepath,'lon','lat','depth','date','vvel_ensamble','readme','readme2');
    clear vvel_ensamble readme
end
