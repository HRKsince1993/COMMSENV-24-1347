...
for one = 2:8 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    savepath = [aimpath,'Compose_TempAboveMLD_Global_Monthly_2023-03_to_2024-02_Exp_',first_name{one},name1{1}(end-12:end-5)]
...
%     contourf(fig1)
    ...
    %%
    save([savepath,'.mat'],'lon','lat','date','temp_above_mld')
end
