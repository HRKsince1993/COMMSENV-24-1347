...
for one = 1:10 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    path1 = ['F:\2023PMM_Work\Data_Ensemble\Exp_',first_name{one},'\OcnUvel50m_Global_Casely\'];
    ...
    uvel_ensemble = mean(bin_sst,4);
    
    clear t_uvel_ensemble p_uvel_ensemble hh1 pp1 h1 p1
    for i1 = 1:size(bin_sst,3)
        ...
        t_uvel_ensemble(:,:,i1) = hh1;
        p_uvel_ensemble(:,:,i1) = pp1;
    end
    %%
    % k = 1;
    ...
    %%
    readme2 = name1;
    save(savepath,'lon','lat','date','uvel_ensemble','t_uvel_ensemble','p_uvel_ensemble','readme2');
    clear uvel_ensemble t_uvel_ensemble p_uvel_ensemble
end