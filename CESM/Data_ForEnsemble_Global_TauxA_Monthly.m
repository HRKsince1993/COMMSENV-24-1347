...
for one = 1:10 % 1:Ctrl;2:TPCtrl;3:PMM;4:SEP;5:TIOlg;6:NTAlg;7:NTAandTIOandPMMandSEPlg;8:NTAandTIOandPMMandSEPandWWBb;9:NTAandTIOandPMMandSEPandWWBbmay;
    ...
    data1 = load('F:\2023PMM_Work\bin_data\Taux_March_Liu_SSTGrid.mat');
    ...
    for i1 = 1:length(name1)
        aimpath = ['F:\2023PMM_Work\Data_Ensemble\Exp_',first_name{one},'\TauxA_Casely\'];
        ...
        save(datapath,'date','lon','lat','tauxa','nino4','readme');
    end
end