...
pathfig = [aimpath,'Step1_2023TauxA'];
...
%%
close all
[cs,h] = contourf(fig_lon,1:size(fig1,2),fig1','levelstep',lv_wind);
hold on
[cs2,h2] = contour(fig_lon,1:size(fig1,2),fig1','color',[0,0,0],'levelstep',lv_wind2);
